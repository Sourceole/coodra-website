...
const faqs = [
  ['What POS systems does Coodra connect to?', 'Coodra connects to Shopify, Square, Lightspeed, Clover, WooCommerce, and Odoo. Moneris support is available by account configuration.'],
  ...
  step: [
    {
      ...
      text: 'Connect Shopify, Square, Lightspeed, Clover, WooCommerce, or Odoo so sales and inventory data can sync.',
    },
    {
      '@type': 'HowToStep',
